...
if(pkg.version!=='2.0.0')issues.push(`versão incorreta: ${pkg.version}`);
for(const asset of ['management-v11.js','calendar-v12.js','media-v13.js','match-v20.js','review-fixes-v20.js','v20.css']){
...
console.log(JSON.stringify({version:pkg.version,assets:6,status:'review-ok'}));