...
if(pkg.version!=='3.0.0')issues.push(`versão incorreta: ${pkg.version}`);
for(const asset of ['management-v11.js','calendar-v12.js','media-v13.js','match-v20.js','review-fixes-v20.js','awards-v21.js','offline-careers-v30.js','offline-start-v30.js','v20.css','v21.css','v30.css']){
...
console.log(JSON.stringify({version:pkg.version,assets:11,status:'review-ok'}));
